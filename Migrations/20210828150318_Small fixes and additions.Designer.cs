...
namespace ContestSystem.Migrations
{
    ...
    [Migration("20210828150318_Small fixes and additions")]
    partial class Smallfixesandadditions
    {
            ...
            modelBuilder.Entity("ContestSystem.DbStructure.Models.ContestLocalModerator", b =>
                {
                    ...
                    b.HasOne("ContestSystem.DbStructure.Models.Auth.User", "LocalModerator")
                        .WithMany("ContestLocalModerators")
