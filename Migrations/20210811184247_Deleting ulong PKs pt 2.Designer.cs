...
namespace ContestSystem.Migrations
{
    ...
    [Migration("20210811184247_Deleting ulong PKs pt 2")]
    partial class DeletingulongPKspt2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ContestSystem.DbStructure.Models.Chat", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("ContestSystem.DbStructure.Models.ChatEvent", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("ContestSystem.DbStructure.Models.ChatUser", b =>
                {
                    b.Property<decimal>("ChatId")
                        .HasColumnType("decimal(20,0)");
            ...
            modelBuilder.Entity("ContestSystem.DbStructure.Models.Message", b =>
                {
                    ...
                    b.Property<decimal?>("MessageToReplyId")
                        .HasColumnType("decimal(20,0)");

                    b.Property<long?>("MessageToReplyId1")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("ContestSystem.DbStructure.Models.ChatEvent", b =>
                {
                    b.HasOne("ContestSystem.DbStructure.Models.Chat", "Chat")
                        .WithMany("ChatEvents")
            ...
            modelBuilder.Entity("ContestSystem.DbStructure.Models.Message", b =>
                {
                    ...
                    b.HasOne("ContestSystem.DbStructure.Models.Message", "MessageToReply")
                        .WithMany()
                        .HasForeignKey("MessageToReplyId1");
